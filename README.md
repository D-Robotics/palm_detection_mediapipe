...
| ai\_msg\_pub\_topic\_name | std::string | Topic name for publishing AI messages containing body, head, face, hand boxes, and keypoints detection results.           | No       | Configurable         | /hobot\_mono2d\_palm\_detection |
